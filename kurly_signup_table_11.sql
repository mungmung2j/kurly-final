...
CREATE TABLE `kurly_signup_table_11` (
  ...
  `userGender` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '성별',
  `userBirth` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '생년월일',
  `userChooga` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '추가 입력 사항',
  `userChoogaId` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '추천인 아이디',
  `userChoogaEvent` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '참여 이벤트 명',
...
--
-- 테이블의 인덱스 `kurly_signup_table_11`
--
ALTER TABLE `kurly_signup_table_11`
  ADD PRIMARY KEY (`idx`);
...
--
-- 테이블의 AUTO_INCREMENT `kurly_signup_table_11`
--
ALTER TABLE `kurly_signup_table_11`
